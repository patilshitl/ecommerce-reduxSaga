...
import { fetchProductRequest, addProductToCart, addProductToWishlist } from '../redux/ProductSlice';
    ...
    { productDetails.map((items) => (
      ...
      <Card style={{  }}  className="col-lg-3">
        ...
        <Card.Footer className='d-flex align-items-center justify-content-between'>
          ...
          <Button variant="primary" onClick={() => dispatch(addProductToWishlist(items))}>Add to Wishlist</Button>
        </Card.Footer>
      </Card>
