...
import { fetchCartProductSucess, addProductToCart, removeCartProducts } from '../redux/ProductSlice';
    ...
    { cartProductDetails.map((items) => (
      ...
      <Card style={{  }}  className="col-lg-3">
        ...
        <Card.Footer className='d-flex align-items-center justify-content-between'>
          <Button variant="primary" onClick={() => dispatch(addProductToCart(items))}>Add More</Button>
          <Button variant="primary">{items.quantity}</Button>
          <Button variant="primary" onClick={() => dispatch(removeCartProducts(items.id))} >Remove</Button>
        </Card.Footer>
      </Card>
